...
const valoresProdutos = {
  ...
  "Sapateira":100,"Máquina de lavar":100,"Aspirador de pó":100,"Sanduicheira":100,
  "Liquidificador":170,"Mixer":170,"Jogo de canecas":75,"Jogo de pratos de porcelanato":100,
  "Utensílios de silicone":50,"Boleira de vidro":50,"Garrafa térmica":55,"Escorredor de louça de parede":60,
  "Escorredores de inox":70,"Talheres":60,"Potes herméticos J1":90,"Potes herméticos J2":105,
  "Jogo de copos de vidro":65,"Jogo de tabuleiros":85,"Jogo de pirex":100,"Ralador":50,"Tábua de inox":50,
  "Lixeiras":55,"Suporte para papel higiênico":55,"Kits suporte de toalha":75,"Espelho":80,"Toalhas de banho":100,
  "Toalhas de rosto":50,"Kit porta algodão, escova e cotonete + saboneteira":70,"Cortina":100,"Tapete":70,
  "Capa de almofada":90,"Edredom":120,"2 jogos de lençol":70,"Travesseiros":75,"Cabeceira":60,
  "Capa de colchão impermeável":50,"Sexto de roupa":50,"Mope":50,"Ferro de passar roupa":110,
  "Tábua de passar roupa":100,"Varal de teto":65,"Varal de chão":90,"Panela de pressão":150,"Jogo de panelas":100
};
...
function criarCard(nome,id,limite){
  ...
  div.className="card"; div.dataset.id=id; div.dataset.nome=nome; div.dataset.limite=String(limite);
  ...
  div.innerHTML=`
    ...
    <div class="card-content">
      <h3>${nome}</h3>
      <p>${limite===1?'Item':`Limite de vales: ${limite}`}</p>
      ${inputHTML}
...
async function confirmarCompra(){
  ...
  } catch(err){ console.error(err); document.getElementById('conf-msg').textContent='Erro de comunicação.'; }
}
