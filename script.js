...
const valoresProdutos = {
  ...
  "Espelho":80, "Toalhas de banho":100, "Toalhas de rosto":50,
  "Kit porta algodão, escova e cotonete + saboneteira":70, "Cortina":100, "Tapete":70,
  "Capa de almofada":90, "Edredom":120, "2 jogos de lençol":70, "Travesseiros":75,
  "Cabeceira":60, "Capa de colchão impermeável":50, "Sexto de roupa":50, "Mope":50,
  "Ferro de passar roupa":110, "Tábua de passar roupa":100, "Varal de teto":65,
...
const imagensProdutos = {
  "Sanduicheira":"imagens/SANDUUICHEIRA.jpg", "Liquidificador":"imagens/LIQUIDIFICADOR.jpg",
  "Mixer":"imagens/MIXER.jpg","Jogo de canecas":"imagens/JOGODECANECAS.jpg",
  "Jogo de pratos de porcelanato":"imagens/JOGODEPRATOSPORCELANADO.jpg",
  "Utensílios de silicone":"imagens/UTENCILIOSDESILICONE.jpg","Boleira de vidro":"imagens/BOLEIRADEVIDRO.jpg",
  "Garrafa térmica":"imagens/GARRAFATERMICA.jpg","Escorredor de louça de parede":"imagens/ESCORREDORDELOUÇADEPARADE.jpg",
  "Escorredores de inox":"imagens/ESCORREDORDEINOX.jpeg","Talheres":"imagens/TALHERES.jpg",
  "Potes herméticos J1":"imagens/POTESHERMETICOSJ1.jpg","Potes herméticos J2":"imagens/POTESHERMETICOSJ2.jpg",
  "Jogo de copos de vidro":"imagens/JOGODECOPOSDEVIDRO.jpg","Jogo de tabuleiros":"imagens/JOGODETABULEIROS.jpg",
  "Jogo de pirex":"imagens/JOGODEPIREX.jpg","Ralador":"imagens/RALADOR.jpg","Tábua de inox":"imagens/TABUADEINOX.jpg",
  "Lixeiras":"imagens/LIXEIRA.jpeg","Suporte para papel higiênico":"imagens/SUPORTEHIGIENICO.jpeg",
  "Kits suporte de toalha":"imagens/KITSUPORTEDETOALHA.jpg","Espelho":"imagens/ESPELHO.jpg",
  "Toalhas de banho":"imagens/TOALHASDEBANHO.jpg","Toalhas de rosto":"imagens/TOALHASDEROSTO.jpg",
  "Kit porta algodão, escova e cotonete + saboneteira":"imagens/Kit porta algodão, escova e cotonete + saboneteira.jpg",
  "Cortina":"imagens/CORTINA.jpg","Tapete":"imagens/TAPETE.jpg","Capa de almofada":"imagens/CAPADEALMOFADA.jpg",
  "Edredom":"imagens/EDREDOM.jpg","2 jogos de lençol":"imagens/JOGODELENÇOL.jpg","Travesseiros":"imagens/TRAVESSEIRO.jpeg",
  "Cabeceira":"imagens/CABECEIRA.jpg","Capa de colchão impermeável":"imagens/CAPADECOLCHÃOIMPERMEAVEL.jpg",
  "Sexto de roupa":"imagens/SEXTODEROUPA.jpg","Mope":"imagens/MOPE.jpg","Ferro de passar roupa":"imagens/FERRODEPASSAR.jpg",
  "Tábua de passar roupa":"imagens/TABUADEPASSAR.jpg","Varal de teto":"imagens/VARALTETO.jpg","Varal de chão":"imagens/VARALCHAO.jpg",
  "Panela de pressão":"imagens/PANELADEPRESSÃO.jpg","Jogo de panelas":"imagens/JOGODEPANELA.jpg",
...
function criarCards(){
  let id = 1;
  for(const nome in valoresProdutos){
    const div = document.createElement("div");
    div.className = "card";
    div.dataset.id = id;
    div.dataset.nome = nome;
    div.dataset.limite = "1";
    ...
    div.innerHTML = `
      ...
      <div class="card-content">
        <h3>${nome}</h3>
        <p>Valor: R$ ${valoresProdutos[nome].toFixed(2).replace('.',',')}</p>
...
function abrirConfirm(btn){
  ...
  currentSelection={id:String(id),nome,quantidade:1,comprador};
  document.getElementById('conf-nome').textContent=`Produto: ${nome}`;
  document.getElementById('conf-qtd').textContent=`Quantidade: 1`;
  document.getElementById('conf-unit').textContent=`Valor unitário: R$ ${valoresProdutos[nome].toFixed(2).replace('.',',')}`;
  document.getElementById('conf-total').textContent=`Total: R$ ${valoresProdutos[nome].toFixed(2).replace('.',',')}`;
